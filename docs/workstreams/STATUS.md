...
2026-09-19 | 04-guestd | opus-5 session (ws/04-guestd) | progress | code, unit tests, strace test, fake, nix package and VM test written; docs updated (I-18..I-21); VM test run pending
