...
returns (DECISIONS I-62).

### 5.4 Hourly rollup

The rollup is `internal/billing.Rollup` (DECISIONS I-62; workstream 05 had
...
**As built (DECISIONS I-61).** Stripe retired the `usage_type = metered` /
...
- [ ] Metrics for the rollup duration, the sample gap, the Stripe push
      ...
      I-62), not the `repose_billing_*` names this list was written with:
